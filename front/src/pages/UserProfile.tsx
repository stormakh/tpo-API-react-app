        ...
        <div className="flex h-screen">
            <div className="w-1/5 h-screen pt-32 pl-12">
                ...
                <div className="flex flex-col place-items-start justify-start ml-10 mt-5">
                    <button className={activeButton === 'User' ? Buttonclicked : ButtonNotClicked} onClick={() => handleButtonClick('User')}>User Profile</button>
                    <button className={activeButton === 'CreditCard' ? Buttonclicked : ButtonNotClicked} onClick={() => handleButtonClick('CreditCard')}>Credit Cards</button>
                    <button className={activeButton === 'Orders' ? Buttonclicked : ButtonNotClicked} onClick={() => handleButtonClick('Orders')}>Orders</button>
                    <button className={activeButton === 'LogOut' ? Buttonclicked : ButtonNotClicked} onClick={() => handleButtonClick('LogOut')} >Log Out</button>
                </div>
            </div>
